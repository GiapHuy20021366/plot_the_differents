...
class SSIMDetecter:
    ...
    def get_differents(self):
        ...
        for c in cnts:
            # Compute the bounding box of the contuor adn then draw the bouding box
            # on both input images to represent where the two images different
...
if __name__ == "__main__":
    print("Run")
    calc = SSIMDetecter("src/images/city1.jpg", "src/images/city2.jpg")
