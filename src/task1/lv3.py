'''
    This level try to detect regions closed by edges
    From that, we can change color of region, delete, move or duplicate regions
'''
...
def change_color_regions(opencv_img, num_range=9):
...
if __name__ == "__main__":
    opencv_img = cv2.imread("src/images/1.png")
    # forest(opencv_img)
